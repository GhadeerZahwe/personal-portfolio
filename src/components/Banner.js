...
import headerImg from "../assets/img/ghadeer.jpg";
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <h1>{`Hi! I'm Ghadeer Zahwe `} 
        <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Fullstack Developer", "AI & ML Enthusiast", "Automation Engineer", "UI/UX Designer" ]'>
            <span className="wrap">{text}</span>
        </span>
    </h1>
    <p>
        I'm a Fullstack Developer with experience in .NET Framework and various web technologies. 
